...
void main() async {
  ...
  runApp(MyApp(accounts: accounts, categories: categories, transactions: transactions));
}
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({Key? key, required this.accounts, required this.categories, required this.transactions}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MainScreen(accounts: accounts, categories: categories, transactions: transactions,),
    );
  }
}
